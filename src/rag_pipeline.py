...
class RAGEngine:
    ...
    - rag context is generated by direct text and cosine similarity search
    - relationship boost is applied to entities which were referenced in relevant articles
    - calc token budget -> direct text search -> cosine similarity search -> return rag content
    """
